...
class conf_adapter(val list: List<String>, val view: Int, val type: Int = 0): RecyclerView.Adapter<multi_holder>() {
    ...
    companion object {
        val mods_all = mapOf<String, Int>("Delete all" to R.drawable.delete_all, "Thief mode" to R.drawable.thief_mode, "Backup mode" to R.drawable.backup)
        val mods_recy = listOf("Delete all", "Thief mode", "Backup mode")
